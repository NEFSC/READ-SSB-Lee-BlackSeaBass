...
data_save_name<-glue("nocluster_North_region_data_split{estimation_vintage}.Rds")
tune_file_name<-glue("BSB_ranger_North_region_nocluster_tune{estimation_vintage}.Rds")
final_fit_file_name<-glue("BSB_ranger_North_region_nocluster_results{estimation_vintage}.Rds")

if  (search_type=="Prototype"){
  data_save_name<-glue("nocluster_North_region_data_split_TEST{estimation_vintage}.Rds")
  tune_file_name<-glue("BSB_ranger_North_region_nocluster_tune_TEST{estimation_vintage}.Rds")
  final_fit_file_name<-glue("BSB_ranger_North_region_nocluster_results_TEST{estimation_vintage}.Rds")
