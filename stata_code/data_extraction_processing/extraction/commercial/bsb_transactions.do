...
local sql "select st.docid, st.subtrip, st.area, st.negear, st.mesh_cat, st.record_sail, st.record_land, st.ves_len, st.geartype , cl.camsid, cl.permit, cl.hullid, cl.year, cl.month, cl.week, cl.dlr_date, cl.dlr_mkt as market_code, cl.dlr_grade as grade__code, cl.dlrid, cl.itis_tsn, cl.state, cl.port, cl.lndlb , cl.value , cl.livlb, cl.status from cams_land cl 
