...
2. I didn't use the 'best' set of tuning params, but the 2nd best. 
3. make some figures that characterize the hyperparamter tuning process.
...
here::i_am("writing/tuning_diagnostics.Rmd")
