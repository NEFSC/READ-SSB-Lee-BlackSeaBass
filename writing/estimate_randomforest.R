...
here::i_am("writing/estimate_randomforest.R")
...
readr::write_rds(data_split, file=here("results","ranger",paste0("data_split",estimation_vintage,".Rds")))
...
write_rds(tune_res, file=here("results","ranger",paste0("BSB_ranger_tune",estimation_vintage,".Rds")))
...
write_rds(final_fit, file=here("results","ranger",paste0("BSB_ranger_results",estimation_vintage,".Rds")))
