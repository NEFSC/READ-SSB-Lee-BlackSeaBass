...
Figure \@ref(HedonicMarginals) shows the results for the month, year, and state factor variables. The Year dummies indicate a substantial decrease in the real price of black sea bass over the 2013-2024 period.  Prices also vary by year, month, and state. 
