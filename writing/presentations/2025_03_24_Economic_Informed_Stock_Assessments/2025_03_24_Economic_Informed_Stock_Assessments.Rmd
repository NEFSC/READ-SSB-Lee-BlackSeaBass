...
- Dealer specific effects.  How do we handle the fact that dealers have their own tendencies in terms of how they classify fish?
...
# Hedonic Results
.left-column[
- Estimates in the columns can be interpreted as the average price of a pound of Black Sea Bass for each market catgory.
