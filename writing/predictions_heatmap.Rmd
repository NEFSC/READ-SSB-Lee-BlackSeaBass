...
soft_testing_predictions<-test_data_isocalib_applied %>%
  ungroup()%>%
...
write_rds(soft_testing_predictions, file=here("results","ranger",glue("soft_testing_predictions_nocluster{pred_vintage}.Rds")))
