...
Our ultimate goal is to estimate (simulate, predict) the numbers at length
for the un-measured "Unclassified" fish at a scale that is relevant for the stock
assessment. However, we do not use prices to predict the length of any particular
bundle of fish. Rather, we predict the class membership, that is "Small", 
...
Need to justify having these as explanatory variables (predictors).
    * Stock area (north and south)
    * Semester
    * Recent landings in the stock area by market category
    * recent landings in the state by market category
    * today's landings from a stock area by market category by other boats
    ...
    * trip level landings of black sea bass
