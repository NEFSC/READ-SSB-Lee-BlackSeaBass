...
2. Dealers have their own tendencies in terms of how they classify fish?
...
Other predictors that could be available
  1. CAMS derivied data
      A. STATUS, although it's probably better to put in "state permit" or "no federal permit"
  2. ``dlrid`` and or permit/vessel id.
  3. Daily landings in each of the market categories.  If lots of people are landings Jumbos, probably you will also land Jumbos. 
  4. Daily landings "in the state" of each of the market categories. Same rationale.
  5. Landings of other things (that are caught along with particular market categories?). Like, do we tend to catch lots of smalls when also catching squid or summer flounder?
  6. Mesh size?  Or an interaction of mesh size and gear?  I'm not sure how to construct this for something like "other" or "hook" gears.
