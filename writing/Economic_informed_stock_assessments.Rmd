...
pred_vintage<-"2025-09-18"

nocluster_testing_predictions<-readRDS(here("results","ranger",paste0("aggregate_test_predictions_nocluster_Tsubset",pred_vintage, ".Rds")))
...
knitr::include_graphics(here("results","ranger","tune", paste0("roc_tune_nocluster_Tsubset", pred_vintage, ".png")))
```
...
knitr::include_graphics(here("results","ranger","final", paste0("vipnocluster_Tsubset", pred_vintage, ".png")))
```
...
knitr::include_graphics(here("results","ranger","final", paste0("roc_nocluster_Tsubset", pred_vintage, ".png")))
```
