...
In this application, sales transactions are of similar, but not identical goods.  The hedonic model (Table \ref{HedonicTableA}) suggests that   size, vessel, and attributes impact prices.  Furthermore, transactions on different days are different in two dimensions: there may be seasonal variation in meat quality and daily variation in quantity supplied. There may be regional variation in prices if is systematic variation in transportation costs from dealer to final consumer or differences in costs of processing whole fish into final form  [@samuelson1954transfer; @Krugman1991a].  
