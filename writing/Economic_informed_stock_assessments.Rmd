...
2. Fishing firms catch a vector of size classes. For black sea bass, there are 5 classes (Jumbo, Large, Medium/Market, and Small) 3. Firms can imperfectly adjust their output vector.The goal is always to maximize profits. 
  - Larger fish may be available at certain times of the year.
  - Larger fish may be available at certain parts of the ocean, which is correlated with state or trip length.
  - Larger fish may be available to certain kinds of gear.
  - Larger fish may be available during certain seasons, or during certain years.
4. Fish in the "Unclassified" or "Mixed" category are a combination of sizes, there isn't actually an "unclassified" category.
...
We first estimate a hedonic model in which the price per pound is a function of the transaction level attributes, including  market category, gear, and time of year. There is plenty of literature: @Larkin1999, @Larkin1999a, and @McConnell2000 are early examples.  @Kristofersson2004, @Kristofersson2007, and @Hammarlund2015 examine demand for attributes in a hierarchical linear model. @Gobillon2017 examine buyer- and seller- effects. 

The motivating concern is that independent variables in the "size" that are correlated with size could be impacting prices
