...
camsid_specific_stats<-haven::read_dta(here("data_folder","main","commercial", paste0("camsid_specific_cleaned_",vintage_string,".dta")))

daily_ma<-haven::read_dta(here("data_folder","main","commercial", paste0("daily_ma_",vintage_string,".dta")))

state_ma<-haven::read_dta(here("data_folder","main","commercial", paste0("state_ma_",vintage_string,".dta")))

stockarea_ma<-haven::read_dta(here("data_folder","main","commercial", paste0("stockarea_ma_",vintage_string,".dta")))

dlrid_historical<-haven::read_dta(here("data_folder","main","commercial", paste0("dlrid_historical_stats_",vintage_string,".dta")))
...
estimation_dataset<-cleaned_landings %>%
   mutate(keep = case_when(year<=2014~ 0,
                           year>=2025~ 0,
                           price<0.15 ~ 0,
