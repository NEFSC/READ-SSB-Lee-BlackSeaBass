...
```{r landings and trips, include=FALSE}
...
```{r initial_dataset}
knitr::kable(start_data, caption='Initial Dataset Landings and Trips by stockarea and year', digits=0, align=c("l",rep('r',times=3)))  
```
...
knitr::kable(totals, caption='Four Principal Classes Landings and Trips',format.args = list(big.mark = ","), digits=0, align=c("l",rep('r',times=4)))  
```
