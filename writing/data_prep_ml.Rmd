...
daily_stats<-haven::read_dta(here("data_folder","main","commercial", paste0("daily_cleaned_",vintage_string,".dta")))
#cams_gears<-haven::read_dta(here("data_folder","main","commercial", paste0("cams_gears_",vintage_string,".dta")))
...
# merge in daily statistics
cleaned_landings<-cleaned_landings %>%
  left_join(daily_stats, by=join_by(camsid==camsid, dlr_date==dlr_date), relationship="many-to-one")
