...
It took 1.63 hours to fit the model with partykit
...
readr::write_rds(tune_res, file=here("results","cforest",paste0("BSB_cforest_results",vintage_string,".Rds")))
