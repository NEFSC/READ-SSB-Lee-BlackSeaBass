...
Just 2018 to present
```{r Sizes_over_2018, fig.show = "hold", out.width = "48%", fig.cap="Market Category 2018-2024, All States",  fig.align = "center", echo=FALSE}
knitr::include_graphics(file.path(exploratory_images,c("market_cats_over_2018.png", "fmarket_cats_over_2018.png")))
...
There's some landings that look like aggregates and duplicates. I'm 
```{r Questionables , fig.show = "hold", out.width = "48%", fig.cap="Questionable landings 2020-2024",  fig.align = "center", echo=FALSE}
knitr::include_graphics(file.path(exploratory_images,c("questionable2020.png", "fquestionable2020.png")))
```
