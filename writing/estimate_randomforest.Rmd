...
###################################################
 ...
 # Just for now, just look at post 2018 and take a 50% sample of the data  
...
ranger_model<-rand_forest(mode="classification", trees = 500, min_n=5, mtry=3) %>%
  set_engine("ranger",num.threads=!!my.ranger.threads, na.action="na.learn", respect.unordered.factors="order")
...
We will do 10 fold cross validation over the mtry set of parameters. We'll hold
...
events (i.e. `true_positive + false_positive = 0`). Precision is undefined in this case, and those levels will be removed from the averaged result.  Here is an example:
...
1.  The model is currently not doing a great job at fitting the "small" class.  The prices of 
