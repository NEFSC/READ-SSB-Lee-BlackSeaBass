...
# When testing, take a 50% subset of the data. This is just to test how my code is working   
if(testing==TRUE){
...
trees constant. The number of trees isn't the most important thing.
